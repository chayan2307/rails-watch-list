...
url = "https://api.themoviedb.org/3/movie/top_rated?api_key=2eaaaef6bec349bbb2b930f9fe9d2cb9&language=en-US&page=2"
...
user['results'].each do |result|
  Movie.create(
    ...
    poster_url: "https://www.themoviedb.org/t/p/original#{result['poster_path']}",
